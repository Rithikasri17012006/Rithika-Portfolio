...
<img src={profile} dowload className="w-40 mx-auto rounded-full mb-6 ring-2 ring-purple-500 ring-offset-2 ring-offset-black shadow-[0_0_20px_rgba(168,85,247,0.7)]" />
